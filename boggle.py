...
class Boggle():
    ...
    def __init__(self):
        """sets words variable to equal list returned from read_dict() function"""
        self.words = self.read_dict("words.txt")

    def read_dict(self, dict_path):
        """Read and return all words in dictionary."""

    # reads the words in the text file, takes away white space, and loops it into a list. closes file once loop is complete and returns the list.
    ...
    def make_board(self):
        ...
        for y in range(5):
            # takes 5 random letters using string.ascii_uppercase to set as the row
